...
import es.allblue.lizardon.smartrotom.gui.controls.Container;
import es.allblue.lizardon.smartrotom.gui.controls.Control;
import es.allblue.lizardon.smartrotom.gui.controls.Event;
import es.allblue.lizardon.smartrotom.gui.loading.FillControl;
import es.allblue.lizardon.smartrotom.gui.loading.GuiLoader;
import es.allblue.lizardon.smartrotom.gui.loading.JsonOWrapper;
import es.allblue.lizardon.smartrotom.net.server.SMessageACQuery;
import es.allblue.lizardon.smartrotom.utilities.BlockSide;
import es.allblue.lizardon.smartrotom.utilities.Bounds;
...
public abstract class WDScreen extends GuiScreen {
    ...
    protected void requestAutocomplete(String beginning, boolean matchExact) {
        Lizardon.NET_HANDLER.sendToServer(new SMessageACQuery(beginning, matchExact));
    }
