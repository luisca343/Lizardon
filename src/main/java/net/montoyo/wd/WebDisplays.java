...
public class WebDisplays {
    ...
    public void onPreInit(FMLPreInitializationEvent ev) {
        ...
        Property miniservQuota = cfg.get("main", "miniservQuota", 10241024); //It's stored as a string anyway
        ...
        itemMinePad = ItemsInit.smart_rotom;
    ...
    public void onRegisterItems(RegistryEvent.Register<Item> ev) {
        ...
        ev.getRegistry().registerAll(itemScreenCfg, itemOwnerThief, itemLinker, itemUpgrade, itemLaserPointer, itemCraftComp, itemAdvIcon);
    }
