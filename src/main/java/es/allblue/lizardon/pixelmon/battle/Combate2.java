...
import es.allblue.lizardon.pixelmon.battle.LogHelper;
...
public class Combate2 {
    ...
    public void iniciarLog(){
        ...
        LizardonBattleLog.appendEquipo(equipo1, this, 1);
        LizardonBattleLog.appendEquipo(equipo2, this, 2);
        ...
        for (int i = 0; i < playerPokemon.size(); i++) appendLog(LizardonBattleLog.getSwitchPkmStr(playerPokemon.get(i), 1, i, true, this));

        System.out.println("6.9 Iniciando log");

        for (int i = 0; i < opponentPokemon.size(); i++) appendLog(LizardonBattleLog.getSwitchPkmStr(opponentPokemon.get(i), 2, i, true, this));
    ...
    public void setPosicion(int equipo, int posPokemon, PixelmonWrapper pkm) {
        int posEquipo = LizardonBattleLog.letras.indexOf(equipo);
    ...
    public void setPosicion(String posPokemon, PixelmonWrapper pkm) {
        ...
        int posEquipo = LizardonBattleLog.letras.indexOf(posPokemon.charAt(1));
