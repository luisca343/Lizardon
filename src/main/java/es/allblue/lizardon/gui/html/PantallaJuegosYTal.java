...
public class PantallaJuegosYTal extends GuiScreen {
    ...
    public PantallaJuegosYTal() {
        urlToLoad = MCEF.HOME_PAGE;
    }

    public PantallaJuegosYTal(String url) {
        urlToLoad = (url == null) ? MCEF.HOME_PAGE : url;
    }

    @Override
    public void initGui() {
        RenderizadorJuegosYTal.INSTANCE.hudBrowser = null;
    ...
    public void onGuiClosed() {
        ...
        if(!RenderizadorJuegosYTal.INSTANCE.hasBackup() && browser != null)
            browser.close();
    ...
    protected void actionPerformed(GuiButton src) {
        ...
        if(src.id == 0)
            ...
            String fixedURL = RenderizadorJuegosYTal.INSTANCE.getAPI().punycode(url.getText());
            browser.loadURL(fixedURL);
        } else if(src.id == 3) {
            RenderizadorJuegosYTal.INSTANCE.setBackup(this);
            mc.displayGuiScreen(null);
        } else if(src.id == 4) {
