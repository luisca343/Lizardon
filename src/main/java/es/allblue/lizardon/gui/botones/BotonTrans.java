...
public class BotonTrans extends GuiButtonImage {
    private int u;
    private int v;
    private int textureWidth;
    private int textureHeight;
    private Pantalla pantalla;
    ResourceLocation fondo = new ResourceLocation("lizardon", "textures/trans.png");

    public BotonTrans(int x, int y, int u, int v, int width, int height, int textureWidth, int textureHeight, Pantalla pantalla) {
        super(x, y, u, v, width, height, textureWidth, textureHeight, new ResourceLocation("lizardon", "textures/trans.png"));
        this.x = x;
        this.y = y;
        this.u = u;
        this.v = v;
